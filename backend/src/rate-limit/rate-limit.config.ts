...
export const PRODUCTION_RATE_LIMITS: RateLimitLimits = {
  burst: { limit: 30, ttlMs: 10_000 },
  short: { limit: 150, ttlMs: 60_000 },
  user: { limit: 800, ttlMs: 5 * 60_000 },
  login: { limit: 8, ttlMs: 60_000 },
  register: { limit: 3, ttlMs: 5 * 60_000 },
  deposit: { limit: 5, ttlMs: 60_000 },
  withdraw: { limit: 5, ttlMs: 60_000 },
  transfer: { limit: 10, ttlMs: 60_000 },
  payments: { limit: 5, ttlMs: 60_000 }, // payment creation is POST /wallets/deposit
  destinations: { limit: 10, ttlMs: 60_000 },
  scheduled: { limit: 10, ttlMs: 60_000 },
  securityLimits: { limit: 10, ttlMs: 60_000 },
  accountLockout: {
    maxFailedAttempts: 5,
    lockTtlMs: 10 * 60_000,
  },
