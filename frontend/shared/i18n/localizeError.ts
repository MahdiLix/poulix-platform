import type { FlatMessages, TranslationDictionary } from "./translations";

type Messages = TranslationDictionary["messages"];
type MessageKey = keyof FlatMessages;
...
const SERVER_MESSAGE_KEYS: Record<string, MessageKey> = {
  ...
  "Cannot transfer to yourself": "cannotTransferToSelf",
  "Scheduled payment status cannot be changed": "scheduledPaymentStatusInvalid",
  "Scheduled payment cannot be cancelled": "scheduledPaymentStatusInvalid",
  "Invalid start date": "scheduledStartDateInvalid",
  "Invalid end date": "scheduledStartDateInvalid",
  "Goal is not active": "goalNotActive",
  "Goal cannot be cancelled": "goalCannotBeCancelled",
